...
public class PetRegisterActivity extends AppCompatActivity implements View.OnClickListener {
    ...
    Button edit_pet_birth, btn_species_1, btn_species_2, btn_species_3, btn_pet_breed, btn_sex_female, btn_sex_male, btn_sex_etc, btn_enroll, btn_cancel, btn_choose;
    String[] arr;
    boolean[] mBoolean;
    EditText edit_pet_name, edit_pet_weight, edit_pet_number;

    private static String user_email, pet_species, pet_name_str, pet_birth_str, pet_breed, pet_sex, pet_weight_str, pet_number_str;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        btn_choose = (Button) this.findViewById(R.id.btn_choose_image);
        ...
        btn_enroll.setOnClickListener(new View.OnClickListener() {
            public void onClick(View v) {
                ...
                if (pet_name_str.length() == 0 || pet_birth_str.length() == 0 || pet_species.length() == 0 || pet_breed.length() == 0 || pet_sex.length() == 0 || pet_weight_str.length() == 0 || pet_number_str.length() == 0 || pet_image.length() == 0) {

                    new AlertDialog.Builder(PetRegisterActivity.this).setTitle("알림").setMessage("필수정보가 입력되지 않았습니다").setPositiveButton("확인", null).show();

                } else {

                    insertToDatabase(user_email, pet_name_str, pet_birth_str, pet_species, pet_breed, pet_sex, pet_weight_str, pet_number_str, pet_image);
                    Intent enrollintent = new Intent(PetRegisterActivity.this, PetActivity.class);
    ...
    private void takePhoto() {
        ...
        try {
            ...
            Toast.makeText(PetRegisterActivity.this, "이미지 처리 오류! 다시 시도해주세요.", Toast.LENGTH_SHORT).show();
            finish();
        }
        if (photoFile != null) {
            photoUri = FileProvider.getUriForFile(PetRegisterActivity.this,
...
/*            intent.putExtra("aspectX", 4);
    ...
    protected void onActivityResult(int requestCode, int resultCode, Intent data) {
        ...
        if (requestCode == PICK_FROM_ALBUM) {
            ...
            cropImage();
            MediaScannerConnection.scanFile(PetRegisterActivity.this, //앨범에 사진을 보여주기 위해 Scan을 합니다.
    ...
    protected Dialog onCreateDialog(int id) {
        switch (id) {
            case DIALOG_BREED:
                return new AlertDialog.Builder(PetRegisterActivity.this).setTitle("품종 선택").setItems(R.array.pet_breed, new DialogInterface.OnClickListener() {
    ...
    private void insertToDatabase(String user_email, String pet_name_str, String pet_birth_str, String pet_species, String pet_breed, String pet_sex, String pet_weight_str, String pet_number_str, String pet_image) {
        ...
        class InsertData extends AsyncTask<String, Void, String> {
            ...
            protected void onPreExecute() {
                super.onPreExecute();
                loading = ProgressDialog.show(PetRegisterActivity.this, "Please Wait", null, true, true);
            }
            ...
            protected String doInBackground(String... params) {
                ...
                try {
                    ...
                    String pet_weight_str = (String) params[6];
        ...
        task.execute(user_email, pet_name_str, pet_birth_str, pet_species, pet_breed, pet_sex, pet_weight_str, pet_number_str, pet_image);
    }
